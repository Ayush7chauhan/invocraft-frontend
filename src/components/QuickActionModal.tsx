          ...
          <div className="grid grid-cols-2 gap-3">
            {actions.map((action) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-xl bg-gray-100 dark:bg-gray-700 flex items-center justify-center ${action.color}`}
                  >
