...
type NavOptions = { openWithLowStock?: boolean; openForm?: boolean; reportView?: "all" | "filter" | "chart" };
type DashboardProps = {
        ...
        <div className="w-full max-w-sm bg-white dark:bg-gray-800 min-h-screen relative flex flex-col transition-colors duration-300">
              ...
              <>
                  ...
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <p className="text-xs font-semibold text-[#16A34A] dark:text-green-400 mb-2 tracking-wide uppercase">You Will Get</p>
                        <p className="text-3xl font-bold text-[#14532D] dark:text-green-300 mb-3 leading-tight">{formatAmount(combinedReceivable)}</p>
                        <div className="flex flex-col gap-1 text-[#15803D] dark:text-green-400">
                          <div className="flex items-center gap-2">
                            <Users className="w-4 h-4 flex-shrink-0" />
                            <span className="text-xs font-medium">Business: {formatAmount(totalReceivable)}</span>
                          </div>
                          {personalTheyOwe > 0 && (
                            <div className="flex items-center gap-2">
                              <Users className="w-4 h-4 flex-shrink-0" />
                              <span className="text-xs font-medium">Personal: {formatAmount(personalTheyOwe)}</span>
                            </div>
                          )}
                        </div>
                      </div>
                ...
                <Card className="bg-[#FDECEC] dark:bg-red-900/30 border-[#F9CACA] dark:border-red-800 shadow-xl hover:shadow-2xl transition-all duration-300 ease-out hover:-translate-y-2 cursor-pointer group">
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <p className="text-xs font-semibold text-[#DC2626] dark:text-red-400 mb-2 tracking-wide uppercase">You Will Give</p>
                        <p className="text-3xl font-bold text-[#7F1D1D] dark:text-red-300 mb-3 leading-tight">{formatAmount(combinedPayable)}</p>
                        <div className="flex flex-col gap-1 text-[#DC2626] dark:text-red-400">
                          <div className="flex items-center gap-2">
                            <Users className="w-4 h-4 flex-shrink-0" />
                            <span className="text-xs font-medium">Business: {formatAmount(totalPayable)}</span>
                          </div>
                          {personalYouOwe > 0 && (
                            <div className="flex items-center gap-2">
                              <Users className="w-4 h-4 flex-shrink-0" />
                              <span className="text-xs font-medium">Personal: {formatAmount(personalYouOwe)}</span>
                            </div>
                          )}
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 ease-out hover:-translate-y-1">
                    <CardContent className="p-4">
                      <p className="text-xs font-semibold text-[#6B7280] dark:text-gray-400 mb-2">Today's Sales</p>
                      <p className="text-xl font-bold text-[#16A34A] dark:text-green-400">{formatAmount(todaySales)}</p>
                    </CardContent>
                  </Card>
                  <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 ease-out hover:-translate-y-1">
                    <CardContent className="p-4">
                      <p className="text-xs font-semibold text-[#6B7280] dark:text-gray-400 mb-2">Today's Payments</p>
                      <p className="text-xl font-bold text-[#16A34A] dark:text-green-400">{formatAmount(todayPayments)}</p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 ease-out hover:-translate-y-2 cursor-pointer group">
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <p className="text-xs font-semibold text-[#6B7280] dark:text-gray-400 mb-2 tracking-wide uppercase">Net Balance</p>
                        <p className="text-2xl font-bold text-[#16A34A] dark:text-green-400 leading-tight">{formatAmount(combinedReceivable - combinedPayable)}</p>
                      </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <span className="font-semibold text-xs transition-colors duration-300">Create Invoice</span>
                  </button>
                  <button 
                  ...
                  >
                    ...
                    <span className="font-semibold text-xs transition-colors duration-300">Add Khata Entry</span>
                  </button>
                  <button 
                  ...
                  >
                    ...
                    <span className="font-semibold text-xs transition-colors duration-300">Add Product</span>
                  </button>
                  <button 
                  ...
                  >
                    ...
                    <span className="font-semibold text-xs transition-colors duration-300">Add Customer</span>
                  </button>
                </div>
                ...
                <div className="pt-4 border-t border-[#E5E7EB] dark:border-gray-700 mt-6">
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="text-base font-bold text-[#111827] dark:text-white">Personal</h2>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <button
                    ...
                    >
                      ...
                      <span className="font-semibold text-xs transition-colors duration-300">Friends & Relatives</span>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <span className="font-semibold text-xs transition-colors duration-300">Expenses</span>
                    </button>
                  </div>
                </div>
                ...
                {lowStockProducts.length > 0 && (
                  <Card
                    role="button"
                    tabIndex={0}
                    onClick={() => onNavigate?.('add-product', { openWithLowStock: true })}
                    onKeyDown={(e) => e.key === 'Enter' && onNavigate?.('add-product', { openWithLowStock: true })}
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="text-sm font-semibold text-orange-800 dark:text-orange-300">Low Stock Alert</p>
                      </div>
                      <p className="text-xs text-orange-700 dark:text-orange-400">
                        {lowStockProducts.length} product{lowStockProducts.length > 1 ? 's' : ''} running low — tap to view
                      </p>
                    </CardContent>
                  </Card>
                )}
                  ...
                  {recentTransactions.length > 0 ? (
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 flex-1 min-w-0">
                              <div className="w-12 h-12 rounded-2xl bg-[#F3F4F6] dark:bg-gray-700 flex items-center justify-center text-[#6B7280] dark:text-gray-300 text-xs font-bold transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg shadow-sm flex-shrink-0">
                                {tx.party?.name?.split(" ").map((part: string) => part[0]).slice(0, 2).join("") || "NA"}
                              </div>
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-2 mt-1.5 text-xs">
                                  ...
                                  {tx.note && (
                                    <>
                                      <span className="text-[#D1D5DB] dark:text-gray-600 transition-colors duration-300">•</span>
                                      <span className="text-[#6B7280] dark:text-gray-400 transition-colors duration-300 truncate">{tx.note}</span>
                                    </>
                                  )}
                                </div>
                              </div>
                    ...
                    <Card className="border-gray-200 dark:border-gray-700">
                      <CardContent className="p-8 text-center">
                        <p className="text-sm text-[#9CA3AF] dark:text-gray-400">No transactions yet</p>
                      </CardContent>
                    </Card>
                  )}
                </div>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t-2 border-[#EEF2F7] dark:border-gray-700 flex justify-around py-4 px-2 text-[#9CA3AF] dark:text-gray-400 text-xs transition-colors duration-300 z-20 shadow-lg">
            ...
            >
              ...
              <span className="font-semibold text-xs transition-colors duration-300">Home</span>
            </button>
            <button
              onClick={() => onNavigate?.('add-customer')}
            ...
            >
              ...
              <span className="font-medium text-xs transition-colors duration-300">Customers</span>
            </button>
            <button
            ...
            >
              ...
              <span className="font-medium text-xs transition-colors duration-300">Reports</span>
            </button>
            <button
            ...
            >
              ...
              <span className="font-medium text-xs transition-colors duration-300">Settings</span>
            </button>
          </div>
        </div>
      </div>
