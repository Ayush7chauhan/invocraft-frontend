...
export default function Reports({ onBack }: ReportsProps) {
  ...
  const [filterPeriod, setFilterPeriod] =
    useState<FilterPeriodKey>("this_month");
  ...
  const renderListPanel = () => {
    ...
    const dateLabel =
      selectedList === "transactions" || selectedList === "invoices"
        ? filterRangeLabel
        : null;
      ...
      <div className="mt-6 animate-slide-up report-stagger-0 rounded-2xl border-0 bg-white dark:bg-gray-800 overflow-hidden shadow-xl">
        ...
        <div className="max-h-80 overflow-y-auto p-3 space-y-2 hide-scrollbar">
          {listLoading ? (
            ...
            (listData as ProductItem[]).map((item) => (
              <div
                key={item.id}
                className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200/80 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
              >
            ...
            (listData as CustomerItem[]).map((item) => (
              <div
                key={item.id}
                className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200/80 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
              >
            ...
            (listData as TransactionItem[]).map((tx) => (
              <div
                key={tx.id}
                className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200/80 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
              >
            ...
            (listData as InvoiceItem[]).map((inv) => (
              <div
                key={inv.id}
                className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200/80 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
              >
                ...
                <span className="text-sm font-bold text-[#111827] dark:text-white ml-2">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 hide-scrollbar space-y-10">
            ...
            <div className="space-y-5">
              {summaryData && (
                <div className="grid grid-cols-2 gap-4">
                  <Card
                    className={`${cardClass} animate-slide-up report-stagger-1 bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-900/20 dark:to-green-800/20 border-emerald-200/60 dark:border-emerald-700/50`}
                  ...
                  >
                    <CardContent className="p-4">
                      ...
                      <p className="text-xl font-bold text-gray-900 dark:text-white mt-1.5">
                        {formatAmount(summaryData.total_sales)}
                      </p>
                    </CardContent>
                  </Card>

                  <Card
                    className={`${cardClass} animate-slide-up report-stagger-2 bg-gradient-to-br from-violet-50 to-purple-100 dark:from-violet-900/20 dark:to-purple-800/20 border-violet-200/60 dark:border-violet-700/50`}
                    onClick={() => handleCardClick("invoices")}
                  >
                    <CardContent className="p-4">
                      ...
                      <p className="text-xl font-bold text-gray-900 dark:text-white mt-1.5">
                        {formatAmount(summaryData.net_profit)}
                      </p>
                    </CardContent>
                  </Card>

                  <Card
                    className={`${cardClass} animate-slide-up report-stagger-3 bg-white dark:bg-gray-800/80 border-gray-200/80 dark:border-gray-700/50 shadow-md`}
                    onClick={() => handleCardClick("invoices")}
                  >
                    <CardContent className="p-4">
                  ...
                  <Card
                    className={`${cardClass} animate-slide-up report-stagger-4 bg-white dark:bg-gray-800/80 border-gray-200/80 dark:border-gray-700/50 shadow-md`}
                      ...
                      {recentInvoices.length === 0 ? (
                        ...
                        <ul className="divide-y divide-gray-100 dark:divide-gray-700">
                          {recentInvoices.map((inv) => (
                            <li
                              key={inv.id}
                              className="flex justify-between items-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200"
                            >
              ...
              {[
                {
                  ...
                  className:
                    "bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-900/20 dark:to-green-800/20 border-emerald-200/60 dark:border-emerald-700/50",
                  labelCls: "text-emerald-700 dark:text-emerald-300",
                  valCls: "text-gray-900 dark:text-white",
                  subCls: "text-emerald-600/80 dark:text-emerald-400/80",
                },
                {
                  num: 2,
                  label: "Total Profit",
                  ...
                  sub: filterPeriodLabel,
                  className:
                    "bg-gradient-to-br from-violet-50 to-purple-100 dark:from-violet-900/20 dark:to-purple-800/20 border-violet-200/60 dark:border-violet-700/50",
                  labelCls: "text-violet-700 dark:text-violet-300",
                  valCls: "text-gray-900 dark:text-white",
                  subCls: "text-violet-600/80 dark:text-violet-400/80",
                },
                {
                  num: 3,
                  ...
                  sub: filterPeriodLabel,
                  className:
                    "bg-gradient-to-br from-red-50 to-rose-100 dark:from-red-900/20 dark:to-rose-800/20 border-red-200/60 dark:border-red-700/50",
                  labelCls: "text-red-700 dark:text-red-300",
                  valCls: "text-gray-900 dark:text-white",
                  subCls: "text-red-600/80 dark:text-red-400/80",
                },
                {
                  num: 4,
                  label: "Bills & Invoices",
                  value: `${rangeData.total_invoices} invoices`,
                  sub: `${formatAmount(rangeData.total_sales)} sales`,
                  className:
                    "bg-white dark:bg-gray-800/80 border-gray-200/80 dark:border-gray-700/50 shadow-md",
                  labelCls: "text-gray-700 dark:text-gray-300",
                  valCls: "text-gray-900 dark:text-white",
                ...
                },
                {
                  ...
                  className:
                    "bg-white dark:bg-gray-800/80 border-gray-200/80 dark:border-gray-700/50 shadow-md",
                  labelCls: "text-gray-700 dark:text-gray-300",
                  valCls: "text-red-600 dark:text-red-400",
                  subCls: "text-gray-500 dark:text-gray-400",
                },
              ].map((item) => (
                <Card
                  key={item.num}
                  className={`rounded-2xl shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 ${item.className}`}
                >
                  <CardContent className="p-4">
                    <p
                      className={`text-xs font-semibold uppercase tracking-wider ${item.labelCls}`}
                    >
                      {item.num}. {item.label}
                    </p>
                    <p className={`text-lg font-bold mt-1 ${item.valCls}`}>
                      {item.value}
                    </p>
                    <p className={`text-[10px] mt-0.5 ${item.subCls}`}>
                      {item.sub}
                    </p>
                  </CardContent>
                </Card>
        ...
        <section className="animate-slide-up report-stagger-2">
          ...
          <div className="flex justify-end mb-3">
            ...
            >
              <RefreshCw
                className={`w-4 h-4 ${chartLoading ? "animate-spin" : ""}`}
              />
            </button>
          </div>
          ...
          {chartLoading && chartData.length === 0 ? (
            ...
            <Card className="rounded-2xl border border-dashed border-gray-300 dark:border-gray-600 bg-white/60 dark:bg-gray-800/40 shadow-sm">
              <CardContent className="p-8 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Try another period or add invoices and expenses to see charts.
                </p>
              </CardContent>
            </Card>
          ) : (
              ...
              <div className="grid grid-cols-3 gap-3 mb-4">
                <Card className="rounded-2xl border-0 shadow-md overflow-hidden bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-900/20 dark:to-green-800/20 hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-4">
                    ...
                    <p className="text-base font-bold text-gray-900 dark:text-white mt-1">
                      {formatAmount(chartTotals.sales)}
                    </p>
                ...
                <Card className="rounded-2xl border-0 shadow-md overflow-hidden bg-gradient-to-br from-violet-50 to-purple-100 dark:from-violet-900/20 dark:to-purple-800/20 hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-4">
                    ...
                    <p className="text-base font-bold text-gray-900 dark:text-white mt-1">
                      {formatAmount(chartTotals.profit)}
                    </p>
                ...
                <Card className="rounded-2xl border-0 shadow-md overflow-hidden bg-gradient-to-br from-red-50 to-rose-100 dark:from-red-900/20 dark:to-rose-800/20 hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-4">
                    ...
                    <p className="text-base font-bold text-gray-900 dark:text-white mt-1">
                      {formatAmount(chartTotals.expenses)}
                    </p>
                  ...
                  <div className="h-72">
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={chartData}>
                        ...
                        <Tooltip
                          content={
                            <ChartTooltip formatter={(v) => formatAmount(v)} />
                          }
                        />
                        <Area
                          type="monotone"
                  ...
                  <div className="h-72">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={chartData}>
                        ...
                        />
                        <Bar dataKey="net_profit" fill="#8B5CF6" />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </CardContent>
